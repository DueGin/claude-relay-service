      ...
      <template v-if="false">
        ...
        <div class="mb-6 sm:mb-10">
          ...
          >
            ...
            >
              <h6
                class="mb-2 text-sm font-medium text-orange-800 dark:text-orange-300 sm:text-base"
              >
                Linux 注意事项
              </h6>
          ...
          <div class="mb-8">
            ...
            >
              ...
              <div class="space-y-4">
                <div>
                  <h6
                    class="mb-2 text-sm font-medium text-gray-800 dark:text-gray-300 sm:text-base"
                  >
                    启动 Claude Code
                  </h6>
                  <div
...
const codexConfigContent = computed(() => {
  return {
    configToml: [
      'model_provider = "flux_code"',
      'model = "gpt-5-codex"',
      'model_reasoning_effort = "high"',
      'disable_response_storage = true',
      'preferred_auth_method = "apikey"',
      '',
      '[model_providers.flux_code]',
      'name = "flux_code"',
